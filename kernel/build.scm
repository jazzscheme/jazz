...
(define (jazz.make-kernel-recursive configuration)
  (let ((system (jazz.configuration-system configuration))
    ...
    (define (copy-platform-files)
	 ...
	 (copy-platform-file "foreign/png/lib/macosx/libpng12.0.dylib" (conffile "libpng12.0.dylib"))
         (copy-platform-file "foreign/xrender/lib/macosx/libXrender.1.dylib" (conffile "libXrender.1.dylib")))))
