        ...
        (cond ((equal? action "list")
              ...
              ((or (equal? action "help") (equal? action "?"))
               (let ((console (console-port)))
                 ...
                 (jazz.print "  jbs configure [-name] [-system] [-platform] [-windowing] [-safety] [-optimize] [-debug-environments] [-debug-location] [-debug-source] [-interpret-kernel] [-destination]" console)
                 (jazz.print "  jbs make [target | clean | cleankernel | cleanobject | cleanlibrary]@[configuration]:[image]" console)
                 (jazz.print "  jbs list" console)
                 (jazz.print "  jbs delete [configuration]" console)
                 (jazz.print "  jbs help or ?" console)
                 (jazz.print "  jbs debug" console))
               (exit))
              ((equal? action "debug")
               (jazz.setup-kernel-build)
               (##repl-debug-main))
