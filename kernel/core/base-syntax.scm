                   ...
                   (let ((___new-fp (%%fx+ ___fp ,frame-quads)))
                     (if (%%fx>= ___new-fp (%%thread-stack-limit ___thread))
                       ...
                       (begin
                         ...
                         (jazz:push-stack-frame ___thread ___stack ___fp ___new-fp ',container ,line ,col)
                         (let ((result (let () ,@body)))
                           (%%thread-frame-pointer-set! ___thread ___fp)
                           (jazz:pop-stack-frame ___thread ___stack ___fp ___new-fp ',container ,line ,col)
                           result)))))))))))))
