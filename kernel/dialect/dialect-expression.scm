...
(jazz:add-primitive-patterns     'gambit:table-ref                                    '((safe %%table-ref  <table^any:any>) (safe %%table-ref <table^any^any:any>)))
(jazz:add-primitive-patterns     'gambit:table-set!                                   '((safe %%table-set! <table^any^any:void>)))
...
(jazz:add-primitive-patterns     'gambit:fx+                                          '((safe %%fx+ <fx^fx:fx>)))
(jazz:add-primitive-patterns     'gambit:fx-                                          '((safe %%fx- <fx^fx:fx>)))
(jazz:add-primitive-patterns     'gambit:fx*                                          '((safe %%fx* <fx^fx:fx>)))

(jazz:add-primitive-patterns     'gambit:fl+                                          '(                     (safe %%fl+ <fv^fv:fl>)))
(jazz:add-primitive-patterns     'gambit:fl-                                          '(                     (safe %%fl- <fv^fv:fl>)))
(jazz:add-primitive-patterns     'gambit:fl*                                          '(                     (safe %%fl* <fv^fv:fl>)))
(jazz:add-primitive-patterns     'gambit:fl/                                          '(                     (safe %%fl/ <fv^fv:fl>)))

(jazz:add-primitive-patterns     'gambit:nan?                                         '(                     (safe %%flnan? <fv:bool>)))

(jazz:add-primitive-patterns     'gambit:bitwise-not                                  '((safe %%fxnot <fx:fx>)))
(jazz:add-primitive-patterns     'gambit:bitwise-and                                  '((safe %%fxand <fx^fx:fx>)))
(jazz:add-primitive-patterns     'gambit:bitwise-ior                                  '((safe %%fxior <fx^fx:fx>)))
(jazz:add-primitive-patterns     'gambit:bitwise-xor                                  '((safe %%fxxor <fx^fx:fx>)))
(jazz:add-primitive-patterns     'gambit:arithmetic-shift                             '((safe %%fxarithmetic-shift <fx^fx:fx>)))
...
(jazz:add-primitive-patterns     'gambit:s8vector                                     '((safe          %%s8vector         <fx*:s8vector>)))
(jazz:add-primitive-patterns     'gambit:s8vector-length                              '((safe          %%s8vector-length  <s8vector:fx>)))
(jazz:add-primitive-patterns     'gambit:s8vector-ref                                 '((bounds-unsafe %%s8vector-ref     <s8vector^fx:fx>)))
(jazz:add-primitive-patterns     'gambit:s8vector-set!                                '((bounds-unsafe %%s8vector-set!    <s8vector^fx^any:void>)))

(jazz:add-primitive-patterns     'gambit:u8vector                                     '((safe          %%u8vector         <fx*:u8vector>)))
(jazz:add-primitive-patterns     'gambit:u8vector-length                              '((safe          %%u8vector-length  <u8vector:fx>)))
(jazz:add-primitive-patterns     'gambit:u8vector-ref                                 '((bounds-unsafe %%u8vector-ref     <u8vector^fx:fx>)))
(jazz:add-primitive-patterns     'gambit:u8vector-set!                                '((bounds-unsafe %%u8vector-set!    <u8vector^fx^any:void>)))

(jazz:add-primitive-patterns     'gambit:s16vector                                    '((safe          %%s16vector        <fx*:s16vector>)))
(jazz:add-primitive-patterns     'gambit:s16vector-length                             '((safe          %%s16vector-length <s16vector:fx>)))
(jazz:add-primitive-patterns     'gambit:s16vector-ref                                '((bounds-unsafe %%s16vector-ref    <s16vector^fx:fx>)))
(jazz:add-primitive-patterns     'gambit:s16vector-set!                               '((bounds-unsafe %%s16vector-set!   <s16vector^fx^any:void>)))

(jazz:add-primitive-patterns     'gambit:u16vector                                    '((safe          %%u16vector        <fx*:u16vector>)))
(jazz:add-primitive-patterns     'gambit:u16vector-length                             '((safe          %%u16vector-length <u16vector:fx>)))
(jazz:add-primitive-patterns     'gambit:u16vector-ref                                '((bounds-unsafe %%u16vector-ref    <u16vector^fx:fx>)))
(jazz:add-primitive-patterns     'gambit:u16vector-set!                               '((bounds-unsafe %%u16vector-set!   <u16vector^fx^any:void>)))

(jazz:add-primitive-patterns     'gambit:s32vector                                    '((safe          %%s32vector        <fx*:s32vector>)))
(jazz:add-primitive-patterns     'gambit:s32vector-length                             '((safe          %%s32vector-length <s32vector:fx>)))
(jazz:add-primitive-patterns     'gambit:s32vector-ref                                '((bounds-unsafe %%s32vector-ref    <s32vector^fx:fx>)))
(jazz:add-primitive-patterns     'gambit:s32vector-set!                               '((bounds-unsafe %%s32vector-set!   <s32vector^fx^any:void>)))

(jazz:add-primitive-patterns     'gambit:u32vector                                    '((safe          %%u32vector        <fx*:u32vector>)))
(jazz:add-primitive-patterns     'gambit:u32vector-length                             '((safe          %%u32vector-length <u32vector:fx>)))
(jazz:add-primitive-patterns     'gambit:u32vector-ref                                '((bounds-unsafe %%u32vector-ref    <u32vector^fx:fx>)))
(jazz:add-primitive-patterns     'gambit:u32vector-set!                               '((bounds-unsafe %%u32vector-set!   <u32vector^fx^any:void>)))

(jazz:add-primitive-patterns     'gambit:s64vector                                    '((safe          %%s64vector        <fx*:s64vector>)))
(jazz:add-primitive-patterns     'gambit:s64vector-length                             '((safe          %%s64vector-length <s64vector:fx>)))
(jazz:add-primitive-patterns     'gambit:s64vector-ref                                '((bounds-unsafe %%s64vector-ref    <s64vector^fx:fx>)))
(jazz:add-primitive-patterns     'gambit:s64vector-set!                               '((bounds-unsafe %%s64vector-set!   <s64vector^fx^any:void>)))

(jazz:add-primitive-patterns     'gambit:u64vector                                    '((safe          %%u64vector        <fx*:u64vector>)))
(jazz:add-primitive-patterns     'gambit:u64vector-length                             '((safe          %%u64vector-length <u64vector:fx>)))
(jazz:add-primitive-patterns     'gambit:u64vector-ref                                '((bounds-unsafe %%u64vector-ref    <u64vector^fx:fx>)))
(jazz:add-primitive-patterns     'gambit:u64vector-set!                               '((bounds-unsafe %%u64vector-set!   <u64vector^fx^any:void>)))

(jazz:add-primitive-patterns     'gambit:f32vector                                    '((safe          %%f32vector        <fl*:f32vector>)))
(jazz:add-primitive-patterns     'gambit:f32vector-length                             '((safe          %%f32vector-length <f32vector:fx>)))
(jazz:add-primitive-patterns     'gambit:f32vector-ref                                '((bounds-unsafe %%f32vector-ref    <f32vector^fx:fl>)))
(jazz:add-primitive-patterns     'gambit:f32vector-set!                               '((bounds-unsafe %%f32vector-set!   <f32vector^fx^any:void>)))

(jazz:add-primitive-patterns     'gambit:f64vector                                    '((safe          %%f64vector        <fl*:f64vector>)))
(jazz:add-primitive-patterns     'gambit:f64vector-length                             '((safe          %%f64vector-length <f64vector:fx>)))
(jazz:add-primitive-patterns     'gambit:f64vector-ref                                '((bounds-unsafe %%f64vector-ref    <f64vector^fx:fl>)))
(jazz:add-primitive-patterns     'gambit:f64vector-set!                               '((bounds-unsafe %%f64vector-set!   <f64vector^fx^any:void>)))
...
(jazz:add-primitive-patterns     'gambit:make-s8vector                                '((safe %%make-s8vector  <any*:s8vector>)))
(jazz:add-primitive-patterns     'gambit:make-u8vector                                '((safe %%make-u8vector  <any*:u8vector>)))
(jazz:add-primitive-patterns     'gambit:make-s16vector                               '((safe %%make-s16vector <any*:s16vector>)))
(jazz:add-primitive-patterns     'gambit:make-u16vector                               '((safe %%make-u16vector <any*:u16vector>)))
(jazz:add-primitive-patterns     'gambit:make-s32vector                               '((safe %%make-s32vector <any*:s32vector>)))
(jazz:add-primitive-patterns     'gambit:make-u32vector                               '((safe %%make-u32vector <any*:u32vector>)))
(jazz:add-primitive-patterns     'gambit:make-s64vector                               '((safe %%make-s64vector <any*:s64vector>)))
(jazz:add-primitive-patterns     'gambit:make-u64vector                               '((safe %%make-u64vector <any*:u64vector>)))
(jazz:add-primitive-patterns     'gambit:make-f32vector                               '((safe %%make-f32vector <any*:f32vector>)))
(jazz:add-primitive-patterns     'gambit:make-f64vector                               '((safe %%make-f64vector <any*:f64vector>)))
(jazz:add-primitive-patterns     'gambit:make-table                                   '((safe %%make-table     <any*:table>)))
(jazz:add-primitive-patterns     'gambit:make-condition-variable                      '((safe %%make-condition-variable <any*:any>)))
(jazz:add-primitive-patterns     'gambit:make-mutex                                   '((safe %%make-mutex     <any*:any>)))
(jazz:add-primitive-patterns     'gambit:make-thread                                  '((safe %%make-thread    <any*:any>)))
...
(jazz:add-primitive-predicate 'gambit:s8vector?                            jazz:S8Vector)
(jazz:add-primitive-predicate 'gambit:u8vector?                            jazz:U8Vector)
(jazz:add-primitive-predicate 'gambit:s16vector?                           jazz:S16Vector)
(jazz:add-primitive-predicate 'gambit:u16vector?                           jazz:U16Vector)
(jazz:add-primitive-predicate 'gambit:s32vector?                           jazz:S32Vector)
(jazz:add-primitive-predicate 'gambit:u32vector?                           jazz:U32Vector)
(jazz:add-primitive-predicate 'gambit:s64vector?                           jazz:S64Vector)
(jazz:add-primitive-predicate 'gambit:u64vector?                           jazz:U64Vector)
(jazz:add-primitive-predicate 'gambit:f32vector?                           jazz:F32Vector)
(jazz:add-primitive-predicate 'gambit:f64vector?                           jazz:F64Vector)
(jazz:add-primitive-predicate 'gambit:continuation?                        jazz:Continuation)
...
(jazz:add-primitive-predicate 'gambit:fixnum?                              jazz:Fixnum)
(jazz:add-primitive-predicate 'gambit:flonum?                              jazz:Flonum)
(jazz:add-primitive-predicate 'gambit:keyword?                             jazz:Keyword)
...
(jazz:add-primitive-predicate 'gambit:table?                               jazz:Table)
(jazz:add-primitive-predicate 'gambit:thread?                              jazz:Thread)
(jazz:add-primitive-predicate 'gambit:foreign?                             jazz:Foreign)
