              ...
              (begin
                ...
                (call-with-output-file (list path: file eol-encoding: (jazz:platform-eol-encoding jazz:kernel-platform))
                  (lambda (output)
                    ...
                    (newline output)
                    (jazz:print-variable 'jazz:jazz-updates (map jazz:object->vector (jazz:get-jazz-updates)) output)))
                #t)
            #f)))
