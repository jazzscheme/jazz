...
(jazz:define-variable-override jazz:compile-unit
...
;; this function should be unified with jazz:compile-unit
;; (being careful about jazz:find-unit-product overhead)
(jazz:define-variable-override jazz:custom-compile-unit
...
(jazz:define-variable-override jazz:build-unit
  (lambda (unit-name)
...
(jazz:define-variable-override jazz:get-subunit-names
  (lambda (parent-name #!key (walk-continue? #f))
    (let ((sub-units '()))
