...
(jazz:define-unsafe ^#subf32vector)
...
(jazz:define-unsafe ^#subf64vector)
...
(jazz:define-unsafe ^#get-monotonic-jiffies!)
(jazz:define-unsafe ^#get-monotonic-frequency!)
(jazz:define-unsafe ^#get-monotonic-nanoseconds!)
...
(jazz:define-unsafe ^#subs16vector)
...
(jazz:define-unsafe ^#subs32vector)
...
(jazz:define-unsafe ^#subs64vector)
...
(jazz:define-unsafe ^#subs8vector)
...
(jazz:define-unsafe ^#subu16vector)
...
(jazz:define-unsafe ^#subu32vector)
...
(jazz:define-unsafe ^#subu64vector)
...
(jazz:define-unsafe ^#subu8vector)
