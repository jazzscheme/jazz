...
(test "0" (fmt #f (num 0 2)))
(test "1" (fmt #f (num 1 2)))
(test "10" (fmt #f (num 2 2)))
(test "11" (fmt #f (num 3 2)))
(test "100" (fmt #f (num 4 2)))
(test "-1" (fmt #f (num -1 2)))
(test "-10" (fmt #f (num -2 2)))
(test "1.1" (fmt #f (num 1.5 2)))
(test "0" (fmt #f (num 0 3)))
(test "1" (fmt #f (num 1 3)))
(test "2" (fmt #f (num 2 3)))
(test "10" (fmt #f (num 3 3)))
(test "100" (fmt #f (num 9 3)))
(test "11.2" (fmt #f (num 5.5 4)))
