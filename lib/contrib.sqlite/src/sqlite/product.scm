...
(cond-expand
  (windows
   (define jazz:sqlite-units
     (let ((sqlite-include-path  (jazz:quote-jazz-pathname "foreign/windows/sqlite3/include"))
           (sqlite-lib-path      (jazz:quote-jazz-pathname "foreign/windows/sqlite3/lib")))
...
(cond-expand
  (windows
   (define jazz:platform-files
     (list (cons "foreign/windows/sqlite3/lib/sqlite3.dll" "sqlite3.dll"))))
  (else
   (define jazz:platform-files
     '())))
