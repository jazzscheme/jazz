...
(%%table-set! jazz:type-tests 'gambit.language.runtime:s8vector?           jazz:S8Vector)
(%%table-set! jazz:type-tests 'gambit.language.runtime:u8vector?           jazz:U8Vector)
(%%table-set! jazz:type-tests 'gambit.language.runtime:s16vector?          jazz:S16Vector)
(%%table-set! jazz:type-tests 'gambit.language.runtime:u16vector?          jazz:U16Vector)
(%%table-set! jazz:type-tests 'gambit.language.runtime:s32vector?          jazz:S32Vector)
(%%table-set! jazz:type-tests 'gambit.language.runtime:u32vector?          jazz:U32Vector)
(%%table-set! jazz:type-tests 'gambit.language.runtime:s64vector?          jazz:S64Vector)
(%%table-set! jazz:type-tests 'gambit.language.runtime:u64vector?          jazz:U64Vector)
(%%table-set! jazz:type-tests 'gambit.language.runtime:f32vector?          jazz:F32Vector)
(%%table-set! jazz:type-tests 'gambit.language.runtime:f64vector?          jazz:F64Vector)
