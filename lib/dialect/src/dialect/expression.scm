...
(jazz:add-primitive-predicate 'jazz.language.runtime.kernel:continuation?  jazz:Continuation)
...
(jazz:add-primitive-predicate 'jazz.language.runtime.kernel:keyword?       jazz:Keyword)
...
(jazz:add-primitive-predicate 'jazz.language.runtime.kernel:thread?        jazz:Thread)
(jazz:add-primitive-predicate 'jazz.language.runtime.kernel:foreign?       jazz:Foreign)
