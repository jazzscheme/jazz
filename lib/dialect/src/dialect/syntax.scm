...
(jazz:define-class jazz:Declaration jazz:Lexical-Binding jazz:Object-Class ()
...
(jazz:define-class jazz:Module-Reference jazz:Declaration-Reference jazz:Object-Class jazz:allocate-module-reference
  ())
...
(jazz:define-class jazz:Export-Reference jazz:Declaration-Reference jazz:Object-Class jazz:allocate-export-reference
...
(jazz:define-class jazz:Autoload-Reference jazz:Export-Reference jazz:Object-Class jazz:allocate-autoload-reference
  ())
...
(jazz:define-class jazz:Unit-Declaration jazz:Declaration jazz:Object-Class jazz:allocate-unit-declaration
...
(jazz:define-class jazz:Namespace-Declaration jazz:Declaration jazz:Object-Class ()
...
(jazz:define-class jazz:Module-Declaration jazz:Namespace-Declaration jazz:Object-Class jazz:allocate-module-declaration
...
(jazz:define-class jazz:Export-Invoice jazz:Module-Invoice jazz:Object-Class jazz:allocate-export-invoice
...
(jazz:define-class jazz:Import-Invoice jazz:Module-Invoice jazz:Object-Class jazz:allocate-import-invoice
...
(jazz:define-class jazz:Export-Declaration jazz:Declaration jazz:Object-Class jazz:allocate-export-declaration
...
(jazz:define-class jazz:Export-Syntax-Declaration jazz:Declaration jazz:Object-Class jazz:allocate-export-syntax-declaration
...
(jazz:define-class jazz:Autoload-Declaration jazz:Declaration jazz:Object-Class jazz:allocate-autoload-declaration
...
(jazz:define-class jazz:Macro-Declaration jazz:Declaration jazz:Object-Class jazz:allocate-macro-declaration
...
(jazz:define-class jazz:Local-Macro-Declaration jazz:Declaration jazz:Object-Class jazz:allocate-local-macro-declaration
...
(jazz:define-class jazz:Syntax-Declaration jazz:Declaration jazz:Object-Class jazz:allocate-syntax-declaration
...
(jazz:define-class jazz:Define-Syntax-Declaration jazz:Syntax-Declaration jazz:Object-Class jazz:allocate-define-syntax-declaration
  ())
...
(jazz:define-class jazz:Define-Local-Syntax-Declaration jazz:Syntax-Declaration jazz:Object-Class jazz:allocate-define-local-syntax-declaration
  ())
...
(jazz:define-class jazz:Void-Class jazz:Class jazz:Class ()
  ())
...
(jazz:define-class jazz:Any-Class jazz:Class jazz:Class ()
  ())
...
(jazz:define-class jazz:Walk-Problem jazz:Error jazz:Object-Class ()
...
(jazz:define-class jazz:Walk-Problems jazz:Error jazz:Object-Class jazz:allocate-walk-problems
...
(jazz:define-class jazz:Walk-Warning jazz:Walk-Problem jazz:Object-Class jazz:allocate-walk-warning
  ())
...
(jazz:define-class jazz:Walk-Error jazz:Walk-Problem jazz:Object-Class jazz:allocate-walk-error
  ())
...
(jazz:define-class jazz:Unresolved-Error jazz:Walk-Error jazz:Object-Class jazz:allocate-unresolved-error
...
(jazz:define-class jazz:Symbol-Binding jazz:Lexical-Binding jazz:Object-Class ()
...
(jazz:define-class jazz:Variable jazz:Symbol-Binding jazz:Object-Class jazz:allocate-variable
...
(jazz:define-class jazz:Parameter jazz:Variable jazz:Object-Class jazz:allocate-parameter
  ())
...
(jazz:define-class jazz:Dynamic-Parameter jazz:Parameter jazz:Object-Class jazz:allocate-dynamic-parameter
...
(jazz:define-class jazz:Optional-Parameter jazz:Parameter jazz:Object-Class jazz:allocate-optional-parameter
...
(jazz:define-class jazz:Named-Parameter jazz:Parameter jazz:Object-Class jazz:allocate-named-parameter
...
(jazz:define-class jazz:Rest-Parameter jazz:Parameter jazz:Object-Class jazz:allocate-rest-parameter
  ())
...
(jazz:define-class jazz:Local-Variable-Binding jazz:Lexical-Binding jazz:Object-Class jazz:allocate-local-variable-binding
...
(jazz:define-class jazz:Macro-Symbol jazz:Symbol-Binding jazz:Object-Class jazz:allocate-macro-symbol
...
(jazz:define-class jazz:Form-Binding jazz:Lexical-Binding jazz:Object-Class ()
  ())
...
(jazz:define-class jazz:Declaration-Form jazz:Form-Binding jazz:Object-Class jazz:allocate-declaration-form
...
(jazz:define-class jazz:Special-Form jazz:Form-Binding jazz:Object-Class jazz:allocate-special-form
...
(jazz:define-class jazz:Macro-Form jazz:Form-Binding jazz:Object-Class jazz:allocate-macro-form
...
(jazz:define-class jazz:Syntax-Form jazz:Form-Binding jazz:Object-Class jazz:allocate-syntax-form
...
(jazz:define-class jazz:Define-Syntax-Form jazz:Syntax-Form jazz:Object-Class jazz:allocate-define-syntax-form
...
(jazz:define-class jazz:Define-Local-Syntax-Form jazz:Syntax-Form jazz:Object-Class jazz:allocate-define-local-syntax-form
...
(jazz:define-class jazz:Proclaim jazz:Expression jazz:Object-Class jazz:allocate-proclaim
...
(jazz:define-class jazz:Constant jazz:Expression jazz:Object-Class jazz:allocate-constant
...
(jazz:define-class jazz:Delay jazz:Expression jazz:Object-Class jazz:allocate-delay
...
(jazz:define-class jazz:Quasiquote jazz:Expression jazz:Object-Class jazz:allocate-quasiquote
...
(jazz:define-class jazz:Binding-Reference jazz:Expression jazz:Object-Class jazz:allocate-binding-reference
...
(jazz:define-class jazz:Assignment jazz:Expression jazz:Object-Class jazz:allocate-assignment
...
(jazz:define-class jazz:Body jazz:Expression jazz:Object-Class jazz:allocate-body
...
(jazz:define-class jazz:Internal-Define jazz:Expression jazz:Object-Class jazz:allocate-internal-define
...
(jazz:define-class jazz:Begin jazz:Expression jazz:Object-Class jazz:allocate-begin
...
(jazz:define-class jazz:Call jazz:Expression jazz:Object-Class jazz:allocate-call
...
(jazz:define-class jazz:If jazz:Expression jazz:Object-Class jazz:allocate-if
  ((test %%get-if-test ())
   (yes  %%get-if-yes ())
   (no   %%get-if-no ())))
...
(jazz:define-class jazz:Cond jazz:Expression jazz:Object-Class jazz:allocate-cond
...
(jazz:define-class jazz:Case jazz:Expression jazz:Object-Class jazz:allocate-case
...
(jazz:define-class jazz:And jazz:Expression jazz:Object-Class jazz:allocate-and
...
(jazz:define-class jazz:Or jazz:Expression jazz:Object-Class jazz:allocate-or
...
(jazz:define-class jazz:Declare jazz:Expression jazz:Object-Class jazz:allocate-declare
...
(jazz:define-class jazz:Parameterize jazz:Expression jazz:Object-Class jazz:allocate-parameterize
...
(jazz:define-class jazz:Time-Special jazz:Expression jazz:Object-Class jazz:allocate-time
...
(jazz:define-class jazz:Walk-Failed-Special jazz:Expression jazz:Object-Class jazz:allocate-walk-failed
