...
(unit jazz.graphic.opengl.install
...
(cond-expand
  (windows
    ...
    (jazz:register-foreign-libraries 'jazz.graphic.opengl.platform.windows 'opengl32))
  (cocoa
    (jazz:register-foreign-libraries 'jazz.graphic.opengl.glew.foreign     'OpenGL 'glew)
    (jazz:register-foreign-libraries 'jazz.graphic.opengl.glew.header      'OpenGL 'glew))
  (else)))
