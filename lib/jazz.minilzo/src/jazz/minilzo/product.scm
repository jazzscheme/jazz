...
(define (jazz:build-minilzo descriptor #!key (unit #f) (force? #f))
  (let ((unit-specs jazz:minilzo-units))
...
(jazz:register-product 'jazz.minilzo
  build: jazz:build-minilzo))
