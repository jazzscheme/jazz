...
(cond-expand
  (ios
   (define jazz:ios-units
     `((jazz.platform.ios.foreign ld-options: "-framework CoreFoundation -framework CoreGraphics -framework StoreKit" custom-cc: ,jazz:custom-cc custom-cc-options: ,jazz:custom-cc-options output-language: objc)
       (angry.database ld-options: "-ObjC -F/Users/magnan/CDSCode/CDSProducts/TestCairo2 -framework CoreFoundation -framework CoreGraphics -lz -lsqlite3 -framework SystemConfiguration -framework Security -framework CouchbaseLite -framework CFNetwork " custom-cc: ,jazz:custom-cc custom-cc-options: ,jazz:custom-cc-options output-language: objc))))
  (else))
