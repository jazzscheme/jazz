...
(cond-expand
  ...
  (windows
   (define jazz:zlib-units
     (let ((zlib-include-path  (jazz:quote-jazz-pathname "lib/jazz.zlib/foreign/windows/include"))
           (zlib-lib-path      (jazz:quote-jazz-pathname "lib/jazz.zlib/foreign/windows/lib")))
       `((jazz.zlib.foreign
           cc-options: ,(string-append "-I" zlib-include-path)
           ld-options: ,(string-append "-L" zlib-lib-path " -lz"))))))
  (else
   (define jazz:zlib-units
     (let ((zlib-include-path  (jazz:quote-jazz-pathname "lib/jazz.zlib/foreign/linux/include"))
           (zlib-lib-path      (jazz:quote-jazz-pathname "lib/jazz.zlib/foreign/linux/lib")))
       `((jazz.zlib.foreign
           cc-options: ,(string-append "-I" zlib-include-path)
...
(define (jazz:zlib-library-options descriptor add-language)
  (cond-expand
    (cocoa
      (list "-lz.1"))
    (windows
      (let ((zlib-lib-path (jazz:jazz-pathname "lib/jazz.zlib/foreign/windows/lib")))
