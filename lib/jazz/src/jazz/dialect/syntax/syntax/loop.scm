...
(module protected jazz.dialect.syntax.syntax.loop scheme


(import (jazz.dialect.runtime.kernel)
        (jazz.dialect.syntax.syntax.increase (phase syntax))
        (jazz.dialect.syntax.syntax.bind (phase syntax))
        (jazz.dialect.syntax.syntax.macros (phase syntax)))
