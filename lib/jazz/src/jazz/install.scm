...
(jazz.register-jazz-literal 'CSS-File-Entry            'jazz.literals 'construct-css-file-entry)
(jazz.register-jazz-literal 'CSS-Entry                 'jazz.literals 'construct-css-entry)
(jazz.register-jazz-literal 'Java-File-Entry           'jazz.literals 'construct-java-file-entry)
(jazz.register-jazz-literal 'JavaScript-File-Entry     'jazz.literals 'construct-javascript-file-entry)
(jazz.register-jazz-literal 'JavaScript-Variable-Entry 'jazz.literals 'construct-javascript-variable-entry)
(jazz.register-jazz-literal 'JavaScript-Function-Entry 'jazz.literals 'construct-javascript-function-entry)
(jazz.register-jazz-literal 'Lua-File-Entry            'jazz.literals 'construct-lua-file-entry)
(jazz.register-jazz-literal 'Lua-Function-Entry        'jazz.literals 'construct-lua-function-entry)
(jazz.register-jazz-literal 'Properties-File-Entry     'jazz.literals 'construct-properties-file-entry)
(jazz.register-jazz-literal 'Properties-Entry          'jazz.literals 'construct-properties-entry)
(jazz.register-jazz-literal 'Python-File-Entry         'jazz.literals 'construct-python-file-entry)
(jazz.register-jazz-literal 'Python-Class-Entry        'jazz.literals 'construct-python-class-entry)
(jazz.register-jazz-literal 'Python-Def-Entry          'jazz.literals 'construct-python-def-entry)
